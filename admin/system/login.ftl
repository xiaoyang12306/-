...
#submit-btn {  
    background-color: #D81B60 !important; /* 使用!important来覆盖可能存在的其他样式 */  
    color: white;
    border-color: #D81B60; 
}
/* 当文本框获取焦点时 */  
#username:focus, #password:focus, #cpacha:focus {  
    border: 1px solid #D81B60; /* 设置粉色边框 */  
    outline: none; /* 移除默认的聚焦轮廓 */  
    box-shadow: 0 0 3px #D81B60; /* 添加粉色阴影以增强效果*/  
}  
  
#username:active, #password:active, #cpacha:active {  
  ...
  <div class="lyear-login">
    <div class="login-center">
      ...
      <footer class="col-sm-12 text-center">
        <p class="m-b-0">Copyright © 2024 <a href="${siteUrl!""}"></a>这是肖阳程思琪的 wab!!</p>
      </footer>
    </div>
  </div>
</div>
